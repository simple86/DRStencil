...
int main(int argc, char** argv)
{
    ...
    Usage: drstencil [options] <input_stcfile>
Options:
...
--dist <num>            Specify the number of the distance between points for data-reuse.

--streaming             Apply streaming optimization.
